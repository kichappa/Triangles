		...
		(function (root, factory) {
			...
			var drag = (function () {
				...
				function on(elem, evt, handler) {
					...
					elem.addEventListener(evt, handler, supportsPassive ? {
						passive: false
					} : false);
				}
			...
			e.namedColors = {}, e.installColorSpace = function (r, n, i) {
				...
				e[r] = function (e) {
					...
					n.forEach(function (e, t) {
						var i = a[t];
						if ("alpha" === e) this._alpha = isNaN(i) || i > 1 ? 1 : i < 0 ? 0 : i;
						else {
				...
				["valueOf", "hex", "hexa", "css", "cssa"].forEach(function (e) {
					...
					for (var i = 0; i < n.length; i += 1)
						if (Math.abs(this["_" + n[i]] - e["_" + n[i]]) > a) return !1;
					return !0
				}, s.toJSON = function () {
			...
			var o = e,
					...
					e.installColorSpace("XYZ", ["x", "y", "z", "alpha"], {
						fromRgb: function () {
							var a = function (e) {
								...
								r = a(this._green),
								n = a(this._blue);
							return new e.XYZ(.4124564 * t + .3575761 * r + .1804375 * n, .2126729 * t + .7151522 * r + .072175 * n, .0193339 * t + .119192 * r + .9503041 * n, this._alpha)
						},
						rgb: function () {
							var a = this._x,
								t = this._y,
							...
							return new e.RGB(n(3.2404542 * a + -1.5371385 * t + -.4985314 * r), n(-.969266 * a + 1.8760108 * t + .041556 * r), n(.0556434 * a + -.2040259 * t + 1.0572252 * r), this._alpha)
						},
						lab: function () {
							var a = function (e) {
				...
				u = function (e) {
					e.installColorSpace("HSV", ["hue", "saturation", "value", "alpha"], {
						...
						hsl: function () {
							var a, t = (2 - this._saturation) * this._value,
					...
					e.installColorSpace("CMYK", ["cyan", "magenta", "yellow", "black", "alpha"], {
						...
						fromRgb: function () {
							var a = this._red,
								...
								o = 1 - r,
								s = 1;
							return a || t || r ? (s = Math.min(n, Math.min(i, o)), n = (n - s) / (1 - s), i = (i - s) / (1 - s), o = (o - s) / (1 - s)) : s = 1, new e.CMYK(n, i, o, s, this._alpha)
						}
					});
				},
				c = function (e) {
				...
				g = function (e) {
					...
					e.installMethod("greyscale", a).installMethod("grayscale", a);
				},
				_ = function (e) {
				...
				M = function (e) {
					e.installMethod("toAlpha", function (e) {
						...
						}), r._red > r._green ? r._red > r._blue ? a._alpha = r._red : a._alpha = r._blue : r._green > r._blue ? a._alpha = r._green : a._alpha = r._blue, a._alpha < 1e-10 ? a : (n.forEach(function (e) {
							a[e] = (a[e] - t[e]) / a._alpha + t[e];
						}), a._alpha *= r._alpha, a)
					});
				};
			return o.use(s).use(f).use(u).use(l).use(h).use(c).use(d).use(b).use(p).use(g).use(_).use(m).use(w).use(y).use(v).use(k).use(M)
		});
